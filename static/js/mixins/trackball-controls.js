...
App.three.TrackballControls = function(object, domElement) {
  ...
  // internals
  this.target = new App.three.Vector3();

  var lastPosition = new App.three.Vector3();

  var _state = STATE.NONE,
    _prevState = STATE.NONE,

    _eye = new App.three.Vector3(),

    _rotateStart = new App.three.Vector3(),
    _rotateEnd = new App.three.Vector3(),

    _zoomStart = new App.three.Vector2(),
    _zoomEnd = new App.three.Vector2(),

    _touchZoomDistanceStart = 0,
    _touchZoomDistanceEnd = 0,

    _panStart = new App.three.Vector2(),
    _panEnd = new App.three.Vector2();
  ...
  this.getMouseProjectionOnBall = (function() {
    ...
    var objectUp = new App.three.Vector3(),
      mouseOnBall = new App.three.Vector3();


    return function(pageX, pageY, projection) {

      mouseOnBall.set(
      (pageX - _this.screen.width * 0.5 - _this.screen.left) / (_this.screen.width * .5), (_this.screen.height * 0.5 + _this.screen.top - pageY) / (_this.screen.height * .5), 0.0);
  ...
  this.rotateCamera = (function() {
    ...
    var axis = new App.three.Vector3(),
      quaternion = new App.three.Quaternion();
  ...
  this.panCamera = (function() {
    ...
    var mouseChange = new App.three.Vector2(),
      objectUp = new App.three.Vector3(),
      pan = new App.three.Vector3();
...
App.three.TrackballControls.prototype = Object.create(App.three.EventDispatcher.prototype);
